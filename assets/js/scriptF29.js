...
function pausarConteo() {
	...
	if (frase1 == "me apetece dormir una larga siesta ") {
	...
	if (frase2 == "el cielo está repleto de nubes ") {
	...
	if (frase3 == "tomamos leche fresca en el pueblo ") {
	...
	if (frase4 == "la tormenta ha estropeado muchos televisores ") {
