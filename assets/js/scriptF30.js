...
function pausarConteo() {
	...
	if (frase1 == "hemos ido de paseo por el parque ") {
	...
	if (frase2 == "he hablado con los hermanos de Juan ") {
	...
	if (frase3 == "voy a mudarme de piso en verano ") {
	...
	if (frase4 == "Alberto trabaja en una ferretería de Madrid ") {
