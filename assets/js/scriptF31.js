...
function pausarConteo() {
	...
	if (frase1 == "ella se encontró un billete en la calle ") {
	...
	if (frase2 == "Noelia lleva un delicado pañuelo de seda india ") {
	...
	if (frase3 == "el señor Luis tiene un barco en Santander ") {
	...
	if (frase4 == "en la plaza del pueblo hay un mercadillo ") {
