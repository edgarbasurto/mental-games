...
<body>
	...
	<header>
		<div class="wrapper">
			<img class="logo" alt="JuegosMentales" src="assets/imagenes/mentalgames2.png">
			<nav>
				<a href="index.php">Inicio</a>
				<a href="contact_us.html">Contáctanos</a>
				<a href="#openModal">Objetivos</a>
			</nav>
		</div>
	</header>

	<div class="titulo">
		<h1 class="titPrinc">ESTIMULACIÓN COGNITIVA PARA ADULTOS MAYORES</h1>
	</div>
	<p class="imgCentro">
		<img class="img2" alt="Juegos Mentales - Por Lcda. Jacqueline Heras S." src="assets/imagenes/mental_games.png">
	</p>
	<h2 class="iniciar">
		<a href="views/contenido.php">INICIAR</a>
	</h2>
