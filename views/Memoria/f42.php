	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="contenido-juego">
					...
					<div class="item-cuadro pos4">
						<img alt="imagen" src="assets/imagenes/memoria/m42-01.png" style="width: 100%;">
					</div>
					<div class="item-cuadro pos5">
						<img alt="imagen" src="assets/imagenes/memoria/m42-02.png" style="width: 100%;">
					</div>
				</div>
			...
			<div class="card-footer text-end">
				<a type="button" onclick="pausarConteo()" class="btn btn-primary" href="?c=memoria&a=ficha43">
