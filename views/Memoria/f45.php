...
<body>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="draggable-elements">
                        <i class="draggable" draggable="true" id="box1">TV</i>
                        <i class="draggable" draggable="true" id="box2">Lavadora</i>
                        <i class="draggable" draggable="true" id="box2">Refrigerador</i>
                    </div>
    ...
    <script src="assets/js/scriptF45.js"></script>
</body>
