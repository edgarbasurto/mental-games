	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="?c=<?php echo ($_SESSION['ModuloActual']) ?>&a=<?php echo ($_SESSION['FichaActual']) ?>" type="button" class="btn btn-secondary" data-dismiss="modal" onclick="reset()">Reintentar</a>
